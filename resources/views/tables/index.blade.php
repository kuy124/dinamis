...
<body>
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <i class="fa-solid fa-arrow-right-to-bracket fa-flip-horizontal"></i> <span>Logout</span>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="main-content">
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="table-card">
                        ...
                        <div class="d-flex justify-content-between mt-3">
                            <a href="{{ route('tables.show', $table) }}" class="btn btn-action">
                                <i class="fas fa-eye me-2"></i>Lihat Tabel
                            </a>
                            <button type="button" class="btn btn-danger btn-action" data-bs-toggle="modal" data-bs-target="#deleteModal-{{ $table->id }}">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Apakah Anda yakin ingin menghapus tabel "<strong>{{ $table->table_name }}</strong>" dan semua catatannya? Tindakan ini tidak dapat dibatalkan.
                            </div>
        ...
        {{-- @if ($tables->isNotEmpty())
            <a href="{{ route('charts') }}" class="btn btn-success btn-lg btn-floating btn-floating-chart" title="Lihat Grafik">
                <i class="fas fa-chart-bar"></i>
            </a>
        @endif --}}

        <a href="{{ route('tables.create') }}" class="btn btn-primary btn-lg btn-floating" title="Buat Tabel Baru">
